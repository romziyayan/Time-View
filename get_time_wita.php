...
if (time() - $last < 0) {
  ...
  $servers = array('galleon-systems.co.uk','0.uk.pool.ntp.org','1.uk.pool.ntp.org','2.uk.pool.ntp.org','3.uk.pool.ntp.org');
...
echo "var servertimeOBJ = new Date($ntp_time_java);var TimeZone = 'WITA';";
?>
